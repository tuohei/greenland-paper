...
#/cluster/home/the038/pyvenv/bin/python -u /cluster/home/the038/regrid_des2021/regrid_UM.py

IDIR=/cluster/work/users/the038/massflux/regrid/
cd $IDIR
OF=Ucorr.1979-2018.greenland_box.regrid.nc

cdo mergetime Ucorr.1979-2018.greenland_box.nc.*.nc $OF
