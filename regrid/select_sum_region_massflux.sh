...
# Prepare input files
IDIR='/cluster/work/users/the038/massflux/regrid/'
IF0=$IDIR'Ucorr.1979-2018.greenland_box.regrid.nc'
...
# Outfiles
OF0=$IDIR'south_west.Ucorr.1979-2018.nc'
OF0s=$IDIR'south_west.Ucorr.1979-2018.summed.nc'
