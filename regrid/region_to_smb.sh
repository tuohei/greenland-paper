...
IDIR2='/cluster/work/users/the038/divD_des2021/decor_des2021/regrid_runmean/'
IF0=$IDIR'south_west_divD.WN0-3.1979-2018.anom.nc'
#IF0i=$IDIR'divD.WN0-3.greenland_box.smoothed.anom.regrid.Icemask.nc'
IF1=$IDIR'south_west_divD.WN4-5.1979-2018.decorWN0-3.anom.nc'
REG0=$IDIR2'reg.divD.WN0-3.SMB.1979-2018.10d_rm.nc'
REG1=$IDIR2'reg.divD.WN4-5.decorWN0-3.SMB.1979-2018.10d_rm.nc'
...
# Outfiles
OF0=$IDIR'south_west_divD.WN0-3.1979-2018.anom.to_smb.nc'
OF0s=$IDIR'south_west_divD.WN0-3.1979-2018.anom.to_smb.summed.nc'
OF1=$IDIR'south_west_divD.WN4-5.1979-2018.decorWN0-3.anom.to_smb.nc'
OF1s=$IDIR'south_west_divD.WN4-5.1979-2018.decorWN0-3.anom.to_smb.summed.nc'

OREG0=$IDIR2'reg.divD.WN0-3.SMB.1979-2018.10d_rm.south_west.nc'
OREG1=$IDIR2'reg.divD.WN4-5.decorWN0-3.SMB.1979-2018.10d_rm.nc.south_west.nc'
cdo selindexbox,$I1,$I2,$I3,$I4 $REG0 $OREG0
cdo selindexbox,$I1,$I2,$I3,$I4 $REG1 $OREG1
cdo mul $IF0 $OREG0 $OF0 
cdo mul $IF1 $OREG1 $OF1 
cdo fldsum $OF0 $OF0s
cdo fldsum $OF1 $OF1s
## South east region
#I1='550'
