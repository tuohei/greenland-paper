...
import glob
fstart = 'Ucorr.1979-2018.greenland_box.nc' 
#datadir = '/cluster/work/users/the038/divD_anom/divD/divergence/anomalies/'
datadir = '/cluster/work/users/the038/massflux/'
spath = f'{datadir}regrid'
...
for year in years:
    ...
    for day in range(ndays):
        ...
        i_data[day,:,:] = ipd_data
    data = xr.Dataset({'UM': (['time','y','x'],i_data),
                    'lat': (['y','x'],lats),
                    'lon': (['y','x'],lons)},
