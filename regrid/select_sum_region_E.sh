...
# Prepare input files
IDIR='/cluster/work/users/the038/divD-WN0-3/regrid_WN0-3/'
IF0=$IDIR'divE.WN0-5.1979-2018.greenland_box.smoothed.anom.nc'
#IF0i=$IDIR'divD.WN0-3.greenland_box.smoothed.anom.regrid.Icemask.nc'
#IF1=$IDIR'divD.WN4-5.1979-2018.greenland_box.smoothed.decorWN0-3.anom.regrid.nc'
...
# Outfiles
OF0=$IDIR'south_west_divE.WN0-5.1979-2018.anom.nc'
OF0s=$IDIR'south_west_divE.WN0-5.1979-2018.anom.summed.nc'
#OF1=$IDIR'south_west_divD.WN4-5.1979-2018.decorWN0-3.anom.nc'
