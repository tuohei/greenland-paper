...
import glob
fstart = 'divD.WN4-5.1979-2018.greenland_box.smoothed.decorWN0-3.anom.90d_rm.nc' 
#datadir = '/cluster/work/users/the038/divD_anom/divD/divergence/anomalies/'
datadir = '/cluster/work/users/the038/divD_des2021/decor_des2021/'
...
for year in years:
    ...
    for day in range(ndays):
        ...
        i_data[day,:,:] = ipd_data
    data = xr.Dataset({'divD': (['time','y','x'],i_data),
                    'lat': (['y','x'],lats),
                    'lon': (['y','x'],lons)},
