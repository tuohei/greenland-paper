...
fnames = ['totrad.decorTP.1979-2019.anom.10d_rm.regrid.trend.nc',
          'TP.1979-2019.anom.10d_rm.regrid.trend.nc',
         ]
...
#             )
plt.tight_layout()
fig.savefig('figures/trends.totrad.TP.1979-2018.pdf')
fig.savefig('figures/trends.totrad.TP.1979-2018.png')
plt.show()
