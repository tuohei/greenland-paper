...
fnames = [f'{datadir2}reg.divD.WN0-3.SMB.1979-2018.180d_rm.nc',
          f'{datadir2}reg.divD.WN4-5.decorWN0-3.SMB.1979-2018.180d_rm.nc',
          f'{datadir2}reg.divQ.WN0-3.SMB.1979-2018.180d_rm.nc',
          f'{datadir2}reg.divQ.WN4-5.decorWN0-3.SMB.1979-2018.180d_rm.nc']
...
plt.tight_layout(rect = (0,0.1,1,1))
fig.savefig('figures/trend.syn.plan.toSMB.des2021.timmean.1979-2018.WN0-3.WN4-5.180d_rm.pdf')
fig.savefig('figures/trend.syn.plan.toSMB.des2021.timmean.1979-2018.WN0-3.WN4-5.180d_rm.png')
plt.show()
