...
fnames = ['divQ.WN0.1979-2018.greenland_box.smoothed.decorWN1-3.timmean.nc',
          'divQ.WN1-3.WN0.cor_component.1979-2018.greenland_box.smoothed.timmean.nc',
          'divQ.WN4-5.WN0.cor_component.1979-2018.greenland_box.smoothed.timmean.nc',
          'divQ.WN0.1979-2018.greenland_box.smoothed.decorWN4-5.timmean.nc']
...
fig.savefig('figures/divQ.timmean.1979-2018.WN0.pdf')
fig.savefig('figures/divQ.timmean.1979-2018.WN0.png')
plt.show()
