...
datadir2 = '/mnt/data/greenland/decor/div_feb2022/'
gpath = f'{datadir}Icemask_Topo_Iceclasses_lon_lat_average_1km.nc' 
fnames = [f'{datadir2}reg.divD.WN0-3.SMB.1979-2018.90d_rm.nc',
          f'{datadir2}reg.divD.WN4-5.decorWN0-3.SMB.1979-2018.90d_rm.nc',
          f'{datadir2}reg.divQ.WN0-3.SMB.1979-2018.90d_rm.nc',
          f'{datadir2}reg.divQ.WN4-5.decorWN0-3.SMB.1979-2018.90d_rm.nc']
...
plt.colorbar(m, 
             orientation = 'horizontal',
             label = r'$\times 10^{-1}$ mm w.e',
             cax = cax,
             ticks = ticks
             )
plt.tight_layout(rect = (0,0.1,1,1))
fig.savefig('figures/trend.syn.plan.toSMB.des2021.timmean.1979-2018.WN0-3.WN4-5.90d_rm.pdf')
fig.savefig('figures/trend.syn.plan.toSMB.des2021.timmean.1979-2018.WN0-3.WN4-5.90d_rm.png')
plt.show()
