...
#fnames = ['LWS.1979-2019.anom.trend.regrid.to_smb.nc',
#          'SWS.1979-2019.anom.trend.regrid.to_smb.nc',
#          'SLH.1979-2019.anom.trend.regrid.to_smb.nc',
#          'SSH.1979-2019.anom.trend.regrid.to_smb.nc',
#          'TP.1979-2019.anom.trend.regrid.to_smb.nc']

fnames = ['LWS.1979-2019.anom.trend.regrid.nc',
          'SWS.1979-2019.anom.trend.regrid.nc',
          'SLH.1979-2019.anom.trend.regrid.nc',
          'SSH.1979-2019.anom.trend.regrid.nc',
          'tot.1979-2019.anom.trend.regrid.nc']
...
#             )
plt.tight_layout()
fig.savefig('figures/trends.rad_prec_reg.1979-2018.pdf')
fig.savefig('figures/trends.rad_prec_reg.1979-2018.png')
plt.show()
