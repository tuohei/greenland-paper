...
fnames2 = ['divD.WN0-3.1979-2018.greenland_box.smoothed.addedWN4-5.trend.regrid.nc',
           'divD.WN4-5.1979-2018.greenland_box.smoothed.decorWN0-3.trend.regrid.nc',
...
fig.savefig('figures/trend.total.SMB.timmean.1979-2018.WN0-3.WN4-5.pdf')
fig.savefig('figures/trend.total.SMB.timmean.1979-2018.WN0-3.WN4-5.png')
plt.show()
