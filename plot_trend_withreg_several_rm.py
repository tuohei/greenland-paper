...
d = xr.open_dataset(f'{dirpath}divQ.WN0-3.1979-2018.90d_rm.smoothed.addedWN4-5.anom.south_west.to_smb.summed.nc')
d3 = xr.open_dataset(f'{dirpath}divQ.WN4-5.1979-2018.90d_rm.smoothed.decorWN0-3.anom.south_west.to_smb.summed.nc')
d4 = xr.open_dataset(f'{dirpath}divQ.WN0-5.1979-2018.90d_rm.smoothed.anom.south_west.to_smb.summed.nc')
d2 = xr.open_dataset(f'{dirpath}south_west_SMB_Icemask.summed.nc')
...
fig1.suptitle(f'{years} year running mean -- reg 90d_rm')
...
fig1.savefig(f'figures/lineplots_{years}yrmean_1979-2017.90d_rm.greenland.Q.png')
fig1.savefig(f'figures.lineplots_{years}yrmean_1979-2017.90d_rm.greenland.Q.eps')
