...
IF1='/cluster/work/users/the038/racmo_smb/anomalies/smb.anom.detrended.90d_rm.nc'
#IF2='/cluster/work/users/the038/racmo_smb/anomalies/smb.anom.detrended.60d_rm.nc'
...
OF1='/cluster/work/users/the038/racmo_smb/anomalies/smb.anom.detrended.90d_rm.south_west.nc'
#OF2='/cluster/work/users/the038/racmo_smb/anomalies/smb.anom.detrended.60d_rm.south_west.nc'
