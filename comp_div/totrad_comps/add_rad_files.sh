...
#cd $IDIR
#F1=$IDIR'SLH/SLH.1979-2019.anom.nc'
#F2=$IDIR'SSH/SSH.1979-2019.anom.nc'
#F3=$IDIR'LWS/LWS.1979-2019.anom.nc'
#F4=$IDIR'SWS/SWS.1979-2019.anom.nc'
#OF=$IDIR'totrad.1979-2019.anom.nc'
#OF2=$IDIR'totrad.1979-2019.anom.10d_rm.nc'
#
#cdo enssum $F1 $F2 $F3 $F4 $OF
#cdo runmean,10 $OF $OF2


/cluster/home/the038/pyvenv/bin/python -u /cluster/home/the038/totrad_comps/regrid_precip.py
#/cluster/home/the038/pyvenv/bin/python -u /cluster/home/the038/totrad_comps/regrid_rad.py

IDIR2=/cluster/work/users/the038/radiation/TP/
cd $IDIR2
OF=TP.1979-2019.anom.10d_rm.regrid.nc
cdo mergetime TP.1979-2019.anom.10d_rm.*.regrid.nc $OF
