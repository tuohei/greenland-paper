...
years = np.arange(2006,2018 + 1,1)
months = ['01','02','03','04','05','06','07','08','09','10','11','12']
dirpath = '/cluster/work/users/the038/divQ_anom/divQ/'
for year in years:
    for month in months:
        vqname = f'vQtotLL.{year}.{month}.WN6.nc'
        uqname = f'uQtotLL.{year}.{month}.WN6.nc'
        ...
        div = div.resample(time = '1D').sum('time')
        div.name = 'divQ'
        div.to_netcdf(f'{dirpath}/divergence2/divQ.WN6.{year}.{month}.nc')
