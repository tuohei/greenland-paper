...
#fnames = [f'{datadir}reg.divD.WN0-3.SMB.1979-2018.90d_rm.nc',
#          f'{datadir}reg.divD.WN4-5.SMB.1979-2018.90d_rm.nc',
#          f'{datadir2}reg.divQ.WN0-3.SMB.1979-2018.90d_rm.nc',
#          f'{datadir2}reg.divQ.WN4-5.SMB.1979-2018.90d_rm.nc']

datadir = '/mnt/data/greenland/decor/div_feb2022/'
gpath = f'{datadir}Icemask_Topo_Iceclasses_lon_lat_average_1km.nc' 
fnames = [f'{datadir}reg.divD.WN0-3.SMB.1979-2018.90d_rm.nc',
          f'{datadir}reg.divD.WN4-5.decorWN0-3.SMB.1979-2018.90d_rm.nc',
          f'{datadir}reg.divQ.WN0-3.SMB.1979-2018.90d_rm.nc',
          f'{datadir}reg.divQ.WN4-5.decorWN0-3.SMB.1979-2018.90d_rm.nc']
...
fig.savefig('figures/reg.syn.plan.SMB.des2021.1979-2018.WN0-3.WN4-5.90d_rm.pdf')
fig.savefig('figures/reg.syn.plan.SMB.des2021.1979-2018.WN0-3.WN4-5.90d_rm.png')
plt.show()
