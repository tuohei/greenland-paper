...
#fnames = [f'{datadir}reg.divD.WN0-3.SMB.1979-2018.10d_rm.summed.nc',
#          f'{datadir}reg.divD.WN4-5.SMB.1979-2018.10d_rm.summed.nc',
#          f'{datadir2}reg.divQ.WN0-3.SMB.1979-2018.10d_rm.summed.nc',
#          f'{datadir2}reg.divQ.WN4-5.SMB.1979-2018.10d_rm.summed.nc']

datadir = '/mnt/data/greenland/decor/div_feb2022/'
gpath = f'{datadir}Icemask_Topo_Iceclasses_lon_lat_average_1km.nc' 
fnames = [f'{datadir}reg.divD.WN0-3.SMB.1979-2018.10d_rm.summed.nc',
          f'{datadir}reg.divD.WN4-5.decorWN0-3.SMB.1979-2018.10d_rm.summed.nc',
          f'{datadir}reg.divQ.WN0-3.SMB.1979-2018.10d_rm.summed.nc',
          f'{datadir}reg.divQ.WN4-5.decorWN0-3.SMB.1979-2018.10d_rm.summed.nc']
...
scale = 1000
lmaxQ = scale*0.00000001
lmaxD = scale*0.000000005
...
fig.savefig('figures/reg.syn.plan.SMB.des2021.1979-2018.WN0-3.WN4-5.10d_rm.summed.pdf')
fig.savefig('figures/reg.syn.plan.SMB.des2021.1979-2018.WN0-3.WN4-5.10d_rm.summed.png')
plt.show()
